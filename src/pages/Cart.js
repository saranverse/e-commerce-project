    ...
    <div className="row d-flex justify-content-between">
        ...
        <div className="col-12 col-lg-3 my-4">
            <div id="order_summary">
                ...
                <hr />
                <p>
                    Subtotal: <span className="order-summary-values">{subtotal} (Units)</span>
                </p>
                <p>
                    Est. total:{" "}
...
</Fragment> : (!complete ? <h2 className="mt-5">Your cart is empty!</h2>:<Fragment> <h2 className="mt-5">Order complete!</h2><p>Your order has been placed succesfully.</p></Fragment>)
}
